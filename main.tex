...
\usepackage[backend=bibtex,style=authoryear,natbib=true,refsection=chapter]{biblatex} % Use the bibtex backend with the authoryear citation style (which resembles APA)
\renewcommand*{\bibfont}{\small}

\addbibresource{Reference_libary_removed_url.bib} % The filename of the bibliography
...
\university{\href{http://www.university.com}{Carl von Ossietzky Univesit{\"a}t Oldenburg}} % Your university's name and URL, this is used in the title page and abstract, print it elsewhere with \univname
\department{\href{http://department.university.com}{Fakult{\"a}t V - Mathematik und Naturwissenschaften}} % Your department's name and URL, this is used in the title page and abstract, print it elsewhere with \deptname
...
\hypersetup{colorlinks=false} % Links should be black and white
}
\linespread{1.5}
...
\large \textit{zur Erlangung des akademischen Grades eines \\\degreename}\\[0.3cm] % University requirement text
\textit{an der}\\[0.4cm]
...
\include{Chapters/Pub1} 
\include{Chapters/Pub2} 
\include{Chapters/Pub3} 
...
% We have bibliographies for each chapter seperately
